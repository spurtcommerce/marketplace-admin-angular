...
export const getCustomTable = () => {
  ...
  {
    displayName: 'marketplace.seller.KYCStatus',
    id: 'onboardingStatus',
    type: 'template',
    checked: true,
    customStyle: {
 ...
 
  {
    ...
    id: 'menu',
    type: 'threeDotMenu',
    isDisable: !updatedPermission['set-vendor-commission'] && !updatedPermission['edit-vendor'] && !updatedPermission['delete-vendor'],
    checked: true,
    menuData: [
      {
        name: 'Set-Commission', img: 'assets/img/percent.svg', displayName: 'common.Set Commission',isDisable: !updatedPermission['set-vendor-commission']
      },
      {
        name: 'Edit', img: 'assets/img/edit.svg', displayName: 'marketplace.seller.Edit',isDisable: !updatedPermission['edit-vendor']
      },
      {
        name: 'Delete', img: 'assets/img/delete-new.svg', displayName: 'marketplace.seller.Delete',isDisable: !updatedPermission['delete-vendor']
      },
...
const filteredActions = availableActions.filter(action => {
  switch (action) {
    ...
    case 'delete':
      return updatedPermission['delete-vendor'];
    case 'resetCheckbox':
