...
export const getCustomTable = () => {
  ...
  },
  {
    ...
    id: 'menu',
    type: 'threeDotMenu',
    isDisable: !updatedPermission['update-seller-group'] && !updatedPermission['delete-seller-group'],
    checked: true,
    customStyle: {
      trow: {
        class: 'text-center'
    ...
    menuData: [
      {
        name: 'Edit', img: 'assets/img/edit.svg', displayName: 'marketplace.seller.Edit',isDisable: !updatedPermission['update-seller-group']
      },
      {
        name: 'Delete', img: 'assets/img/delete-new.svg', displayName: 'marketplace.seller.Delete',isDisable: !updatedPermission['delete-seller-group']
      },
    ]
  }
];
