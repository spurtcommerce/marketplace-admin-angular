...
import { ExportSandbox } from '../../../../../../core/admin/catalog/export/export.sandbox';
import { ExportService } from '../../../../../../core/admin/catalog/export/export.service';
import { ExportEffects } from '../../../../../../core/admin/catalog/export/export.effects/export.effects'
...
@NgModule({
    ...
    imports: [
        ...
        ComponentsModule,
        ImportRoutingModule,
        EffectsModule.forFeature([ImportEffects, ExportEffects, UserEffect, OrdersEffects, ProductEffect, CategoriesEffect, ArchivePaymentEffects, Customereffects])
    ],
    providers: [
        ImportService,
        ImportSandbox,
