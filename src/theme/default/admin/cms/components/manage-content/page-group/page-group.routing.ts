...
const pagesRoutes: Routes = [
  ...
  // < !--------------------------------------- Localization Routes ----------------------------------------------------! >
  {
    ...
    canActivate: [AuthGuard],
    data: {
      permission: 'add-page-group-localization',
  ...
  },
  {
    ...
    data: {
      permission: 'add-page-group-localization', urls: [{ title: 'breadcrumbs.CMS', url: '/cms/manage-content/page-group/list' }, { title: 'CMS.ManageContent.Manage Pages', url: '/cms/manage-content/page-group/list' },
      { title: 'breadcrumbs.Page Group', url: '/cms/manage-content/page-group/list' },
