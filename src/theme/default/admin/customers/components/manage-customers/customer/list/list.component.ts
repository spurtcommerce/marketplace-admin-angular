...
import { badgeStatusMappings, bulkAction, filterFields, getCustomTable, removeEmptyKeys } from './list.constant';
...
export class CustomerListComponent implements OnInit, OnDestroy {
  ...
  //Dynamic columns
  customTable: any = getCustomTable;
  ...
  ngOnInit() {
    ...
    this.viewDeatilsPermission = apiResponse['view-buyer']
