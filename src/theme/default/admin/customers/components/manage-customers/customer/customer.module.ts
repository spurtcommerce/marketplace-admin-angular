...
import { CustomersGroupEffects } from 'src/core/admin/Customers/customers-group/customers-group-effects/customers-group.effects';
...
@NgModule({
    ...
    imports: [
        ...
        MatInputModule,
        MatFormFieldModule, 
        EffectsModule.forFeature([Customereffects,CustomersGroupEffects,SellerEffects]),
