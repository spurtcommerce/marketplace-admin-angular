...
export const getCustomTable = () => {
  ...
  },
  {
    ...
    type: 'threeDotMenu',
    checked: true,
    isDisable: !updatedPermission['edit-category'] && !updatedPermission['delete-category'] ,
    customStyle: {
      trow: {
        class: 'text-center'
      },
    ...
    menuData: [
      {
        name: 'Edit', img: 'assets/img/edit.svg', displayName: 'marketplace.common.Edit', isDisable: !updatedPermission['edit-category'],
      },
      {
        name: 'Delete', img: 'assets/img/delete-new.svg', displayName: 'marketplace.common.Delete', isDisable: !updatedPermission['delete-category'],
      }
    ]
  }
]
