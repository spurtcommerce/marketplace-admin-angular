...
import { ProductVariantEffect } from 'src/core/admin/catalog/product-variant/effect/productVariant.effect';
...
@NgModule({
  ...
  imports: [
    ...
    EffectsModule.forFeature([CategoriesEffect,SellerProductEffect,ProductEffect,TaxEffect,ProductVariantEffect]),
    MatTooltipModule,
    CommonModule,
    FormsModule,
    NgbModule,
