...
import { permissionConfigs } from '../services/permission.constant';
...
export class ProfileBarComponent implements OnInit  {
  ...
  vendorList(){
    this.http.get(this.configService.getBaseUrl()+'/chat-admin/vendor-list').subscribe((val:any)=>{
     if(val.message == 'you dont have access for it, please enable addon') {
