...
fullFuillmentStatus(){
 ...
 private editOrderStatusList():void {
  ...
  private loadForm():void {
    this.OrderStatusName = new UntypedFormControl('', [Validators.required,Validators.maxLength(30),Validators.pattern(/^[a-zA-Z\s]*$/)]);
    this.colorCode = new UntypedFormControl('', [Validators.required]);
    this.priority = new UntypedFormControl('', [Validators.required,Validators.pattern(/^(?:[1-9]|1[0-9]|2[0-9]|30)$/)]);
