...
export class RoleListComponent implements OnInit, OnDestroy {
  ...
  getRolelist() {
    ...
    this.subscriptions.add(this.service.roleList(param).subscribe((res) => {
  ...
  goToPermission(user) {
    ...
    this.router.navigate(['/settings/access-and-permission/permission'], { queryParams: { user: JSON.stringify(details),name:'role' } });
  }
