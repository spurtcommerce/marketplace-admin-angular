...
import { timeZoneArray } from './create.constant';
  ...
  getSettings() {
    ...
    this.multipleWebsitesSandbox.GetSettingsMultipleWebsites$.subscribe((data: any) => {
      if (data) {
        ...
        if (data?.storeLogo) {
          this.postImageUrl = this.imageUrl + '?path=' + data?.storeLogoPath + '&name=' + data?.storeLogo + '&width=267&height=150';
        ...
        this.multipleWebsitesForm.controls['timeZone'].setValue(data?.timeZone);
...
this.timeZone=event.timeZone
  ...
  inItForm() {
    ...
    this.multipleWebsitesForm = this.fb.group({
      ...
      businessName: ["", [Validators.required,Validators.compose([Validators.pattern(/^[a-zA-Z0-9 $,'&-]*$/),Validators.maxLength(100)])]],
      email: ['', [Validators.required, Validators.email, Validators.pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$')]],
      // email: ["", Validators.required],
      mobile: [null, [Validators.required]],
      // mobile: ["", Validators.required],
      businessOwnerName: ["", [Validators.required,Validators.compose([Validators.pattern(/^[a-zA-Z\s]*$/),Validators.maxLength(100)])]],
      address1: ["", [Validators.required,Validators.maxLength(160)]],
      address2: ["", [Validators.required,Validators.maxLength(160)]],
  ...
  createWebsites() {
    ...
    const fieldstab3 = [
      ...
      this.multipleWebsitesForm.controls.timeZone.status,
