...
import * as fromProductVariant from "./admin/catalog/product-variant/reducer/productVariant.reducer"
...
import * as fromExport from "./admin/catalog/export/export.reducer/export.reducer";
