...
export const ActionTypes = {
  ...
  INDUSTRY_LIST: type('[List] IndustryList'),
  INDUSTRY_LIST_SUCCESS: type('[List]  IndustryList Success'),
  INDUSTRY_LIST_FAIL: type('[List]  IndustryList Fail'),

  INDUSTRY_BASED_CATEGORY: type('[List] industryBasedCategory'),
  INDUSTRY_BASED_CATEGORY_SUCCESS: type('[List]  industryBasedCategory Success'),
  INDUSTRY_BASED_CATEGORY_FAIL: type('[List]  industryBasedCategory Fail'),
...
export class industryBasedCategoryAction implements Action {
  type = ActionTypes.INDUSTRY_BASED_CATEGORY;
  constructor(public payload: any) { }
}

export class industryBasedCategorySuccessAction implements Action {
  type = ActionTypes.INDUSTRY_BASED_CATEGORY_SUCCESS;
  constructor(public payload: any) { }
}

export class industryBasedCategoryFailAction implements Action {
  type = ActionTypes.INDUSTRY_BASED_CATEGORY_FAIL;
  constructor(public payload: any) { }
}
...
export type Actions =
  ...
  | IndustryListAction
  | IndustryListSuccessAction
  | IndustryListFailAction
  | industryBasedCategoryAction
  | industryBasedCategorySuccessAction
  | industryBasedCategoryFailAction
