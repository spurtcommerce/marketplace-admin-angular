...
import {
  ...
  industryBasedCategoryLoading,
  industryBasedCategoryLoaded,
...
export class CategoriesSandbox {
  ...
  public industryBasedCategory$ = this.appState.select(industryBasedCategory);
  public industryBasedCategoryLoading$ = this.appState.select(industryBasedCategoryLoading);
  public industryBasedCategoryLoaded$ = this.appState.select(industryBasedCategoryLoaded);
...
public getCategoryTranslationCountFailed$ = this.appState.select(
 ...
 public parentLevels: any = [];
  ...
  public IndustryList(value) {
    this.appState.dispatch(new categoriesActions.IndustryListAction(value));
  }

  public industryBasedCategory(value) {
    this.appState.dispatch(new categoriesActions.industryBasedCategoryAction(value));
  }
