...
export const IndustryList = createSelector(
  getCatState,
  fromCategories.IndustryList
);
export const IndustryListLoading = createSelector(
  getCatState,
  fromCategories.IndustryListLoading
);
export const IndustryListLoaded = createSelector(
  getCatState,
  fromCategories.IndustryListLoaded
);
export const IndustryListFailed = createSelector(
  getCatState,
  fromCategories.IndustryListFailed
);


// industryBasedCategory
export const industryBasedCategory = createSelector(
  getCatState,
  fromCategories.industryBasedCategory
);
export const industryBasedCategoryLoading = createSelector(
  getCatState,
  fromCategories.industryBasedCategoryLoading
);
export const industryBasedCategoryLoaded = createSelector(
  getCatState,
  fromCategories.industryBasedCategoryLoaded
);
export const industryBasedCategoryFailed = createSelector(
  getCatState,
  fromCategories.industryBasedCategoryFailed
);
