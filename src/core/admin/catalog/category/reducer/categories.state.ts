...
export interface CategoriesState extends Map<string, any> {
  ...
  industryBasedCategory: any;
  industryBasedCategoryLoading: boolean;
  industryBasedCategoryLoaded: boolean;
  industryBasedCategoryFailed: boolean;
